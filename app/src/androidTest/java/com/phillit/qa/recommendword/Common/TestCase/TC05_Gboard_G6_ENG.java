...
public class TC05_Gboard_G6_ENG extends BaseTestCase {
    ...
    public TC05_Gboard_G6_ENG(Device device){
        this.device = device;
        testCaseParser = new TestCaseParser("ENG", device);
        gboard = new Gboard(device);
        qwerty_eng = new Qwerty(device, gboard, KeyType.PORTRAIT, KeyType.ENG_QWERTY);
